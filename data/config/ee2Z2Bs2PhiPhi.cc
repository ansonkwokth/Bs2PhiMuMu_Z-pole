...
int main() {
    ...
    HepMC::IO_GenEvent ascii_io("./hepmc_data/ee2Z2Bs2PhiPhi_100k_seed0.hepmc", std::ios::out);
    //========================= Settings =========================================================
    ...
    pythia.readString("531:addChannel = 1 1 100 333 333");
    pythia.readString("333:onMode = off");
    pythia.readString("333:addChannel = 1 0.5 100 13 -13");
    pythia.readString("333:addChannel = 1 0.5 100 321 -321");
