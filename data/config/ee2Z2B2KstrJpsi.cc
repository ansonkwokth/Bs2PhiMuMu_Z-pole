...
int main() {
    ...
    HepMC::IO_GenEvent ascii_io("./hepmc_data/ee2Z2B2KstrJpsi_200k_seed0.hepmc", std::ios::out);
    //========================= Settings =========================================================
